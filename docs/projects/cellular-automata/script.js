(function () {
  ...
  var patterns = {
    ...
    lwss:    { name: "LWSS (SPACESHIP)", cells: [[1,0],[2,0],[3,0],[4,0],[0,1],[4,1],[4,2],[0,3],[3,3]] },
    penta:   { name: "PENTADECATHLON", cells: [[2,0],[7,0],[0,1],[1,1],[3,1],[4,1],[5,1],[6,1],[8,1],[9,1],[2,2],[7,2]] },
    rpento:  { name: "R-PENTOMINO", cells: [[1,0],[2,0],[0,1],[1,1],[1,2]] },
    acorn:   { name: "ACORN", cells: [[1,0],[3,1],[0,2],[1,2],[4,2],[5,2],[6,2]] },
    gun:     { name: "GOSPER GLIDER GUN", cells: [
      [0,4],[0,5],[1,4],[1,5],
